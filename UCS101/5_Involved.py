...
def involved(courses, person):
    ...
    for hexamester in courses:
        for course in courses[hexamester]:
            assistant_check = True if 'assistant' in courses[hexamester][course].keys() and person == \
                                      courses[hexamester][course]['assistant'] else False
            teacher_check = True if 'teacher' in courses[hexamester][course].keys() and person == \
                                    courses[hexamester][course]['teacher'] else False
            if teacher_check or assistant_check:
                if hexamester in involved_in:
                    involved_in[hexamester].append(course)
                else:
                    involved_in[hexamester] = [course]
    return involved_in
